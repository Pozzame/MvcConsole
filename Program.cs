...
class Database{
    ...
    public Database(){
        ...
        _connection.Open();
        var command = new SQLiteCommand("CREATE TABLE IF NOT EXIST uers (id INTEGER PRIMARY KEY, name, TEXT)", _connection);
        command.ExecuteNonQuery();
    }

    public void AddUser(string name){
        var command = new SQLiteCommand("INSERT INTO users (neme) VALUES ('{name}')", _connection);
        command.ExecuteNonQuery();
    }
